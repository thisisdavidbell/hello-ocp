...
import (
	...
	"github.com/thisisdavidbell/hello-ocp/1-create-operator/controllers"
...
func init() {
	...
	utilruntime.Must(hellogroupv1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:   "f3188de7.my.domain",
	})
	if err != nil {
